...
public class TestStage : Stage
{
    ...
    public override IEnumerator StageScript(StageArgs args)
    {
        ...
        for (int i = 0; i < 3; i++)
        {
            _enemyIDs.Add(args.EnemyManager.SpawnEnemy("enemy1",
        ...
        for(int i = 4; i >= 0; i -= 2)
        {
            _enemyIDs.Add(args.EnemyManager.SpawnEnemy("enemy2",
        ...
        for(int i = -2; i <= 2; i += 4)
        {
            _enemyIDs.Add(args.EnemyManager.SpawnEnemy("enemy3",
        ...
        _enemyIDs.Add(args.EnemyManager.SpawnEnemy("boss",
